      ...
      <div class="header-inner clearfix">
        ...
        <div class="movie-info-right">
          ...
          <div class="movie-info-btn">
            <el-button class="buy-btn" type="primary" @click="toCinema">立即购票</el-button>
          </div>
      ...
      <div class="movie-info-detail clearfix">
        <div class="main-content">
          <div class="crumbs-nav-container">
            <a href="/welcome">电影</a> &gt; <a href="/movie">电影</a> &gt; {{movieInfo.movieNameCn}}
          </div>
              ...
              <div class="tab-body">
                <div class="actors-container">
                  <div class="actors-group" v-for="item in movieInfo.actorRoleList">
                    ...
                    <div class="actors-list clearfix">
                      <div class="actor" v-for="actor in item.actorList">
                        <a @click="showPictures" target="_blank" class="portrait">
                          <img class="default-img" :alt="actor.actorName" :src="httpURL + JSON.parse(actor.actorPhoto)[0]">
                        </a>
                        <div class="info">
                          <a @click="showPictures" target="_blank" class="actor-name">
                            {{actor.actorName}}
                          </a>
                        </div>
                      </div>
...
.header{
  ...
  width: 100%;
  min-width: 1200px;
  background: url('../../assets/movie-info-background.png')
}
