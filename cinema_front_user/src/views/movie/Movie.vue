<template>
  <el-container>
    <el-header>
      <el-menu :default-active="$route.path" class="nav-menu" mode="horizontal" :router="true" background-color="#257B5E"
        text-color="#fff" active-text-color="#98FB98">
    ...
    <el-main>
      ...
      <div class="tags-container">
        <div class="tags-line">
          ...
          <el-radio-group v-model="categoryRadio" fill="#257B5E">
            <el-radio-button :label="0">全部</el-radio-button>
            <el-radio-button :label="item.movieCategoryId" v-for="item in categoryList"
              :key="item.movieCategoryId">{{ item.movieCategoryName }}</el-radio-button>
          </el-radio-group>
        </div>
        <div class="tags-line">
          <div class="tags-title">区域:</div>
          <el-radio-group v-model="areaRadio" fill="#257B5E">
            <el-radio-button :label="0">全部</el-radio-button>
            <el-radio-button :label="item.movieAreaId" v-for="item in areaList"
              :key="item.movieAreaId">{{ item.movieAreaName }}</el-radio-button>
          </el-radio-group>
        </div>
        <div class="tags-line">
          <div class="tags-title">年代:</div>
          <el-radio-group v-model="ageRadio" fill="#257B5E">
            <el-radio-button :label="0">全部</el-radio-button>
            <el-radio-button :label="item.movieAgeId" v-for="item in ageList"
              :key="item.movieAgeId">{{ item.movieAgeName }}</el-radio-button>
          </el-radio-group>
        </div>
      </div>
      ...
      <router-view :movieCategoryId="categoryRadio" :movieAreaId="areaRadio" :movieAgeId="ageRadio"
        :orderByColumn="orderByColumn"></router-view>
    </el-main>
  </el-container>
</template>
