<template>
  <div>
    <div class="searchContainer">
      <el-input v-model="keyword" class="searchBar" placeholder="搜索电影、影院"></el-input>
      <el-button id="searchBtn" icon="el-icon-search" style="background-color: #006400;border-color: #006400;" type="primary" circle @click="searchInfo"></el-button>
    </div>
    <div>
