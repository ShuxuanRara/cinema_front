  ...
  <div style="width: 70%">
    <el-form :model="loginUser"  ref="editFormRef" label-width="80px">
      ...
      <el-form-item label="生活状态" prop="condition">
        <el-radio v-model="information.condition" label="1">上学</el-radio>
        <el-radio v-model="information.condition" label="2">工作</el-radio>
        <el-radio v-model="information.condition" label="3">退休</el-radio>
        <el-radio v-model="information.condition" label="4">无所事事</el-radio>
      </el-form-item>
