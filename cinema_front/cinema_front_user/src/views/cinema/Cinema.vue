  ...
  <div>
    <div class="tags-container">
      <div class="tags-line">
        ...
        <el-radio-group v-model="brandRadio" size="medium" fill="#257B5E">
      ...
      <div class="tags-line">
        ...
        <el-radio-group v-model="hallCategoryRadio" size="medium" fill="#257B5E">
          <el-radio-button :label="0">全部</el-radio-button>
      ...
      <div class="tags-line">
        ...
        <el-radio-group v-model="serviceRadio" size="medium" fill="#257B5E">
          <el-radio-button :label="0">全部</el-radio-button>
    ...
    <div class="list-content" v-for="item in cinemaList">
      <div class="list-left">
        ...
        <el-tag size="small" effect="dark" type="danger" v-if="item.isRefunded">可退票</el-tag>
        <el-tag size="small" effect="dark" type="danger" v-if="item.isTicketChanged">可改签</el-tag>
        <el-tag size="small" effect="dark" type="danger" v-for="hall in item.sysHallCategoryList" :key="hall.hallId">{{hall.hallCategoryName}}</el-tag>
      </div>
...
.el-button:hover {
  background-color: #369273 !important;
  border-color: #369273 !important;
}
